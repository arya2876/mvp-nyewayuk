...
export const createReservation = async ({
  ...
  try {
    ...
    // If webhook succeeded, proceed to persist locally (optional depending on n8n setup)
    // Adjust to new schema: reservation references itemId
