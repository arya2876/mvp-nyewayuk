        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div
                className="block w-full opacity-60 cursor-not-allowed"
                aria-label="Coming Soon on App Store"
              >
                <div className="flex items-center gap-3 rounded-lg border-2 border-white/50 px-4 py-2.5 relative">
                  ...
                  <div className="text-white/70 text-left">
                    <div className="text-[10px] leading-tight">Coming Soon</div>
                    <div className="font-semibold text-lg leading-tight">App Store</div>
                  </div>
                  <span className="absolute -top-2 -right-2 bg-[#00A99D] text-white text-[10px] px-2 py-0.5 rounded-full">Soon</span>
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3 rounded-lg border-2 border-white/50 px-4 py-2.5 relative">
                  <svg className="w-9 h-9 opacity-70" viewBox="0 0 512 512">
              ...
              <div className="flex items-center gap-4 pt-4">
                {/* Instagram */}
                <a href="https://www.instagram.com/renle.id/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white hover:text-[#00A99D] transition">
