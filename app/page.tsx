...
import PlatformTestimonials from "@/components/home/PlatformTestimonials";
          ...
          {categories.map((category) => {
            ...
            return (
              <a
                ...
                className={`group flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 category-icon ${isSelected
              ...
              >
                <Icon className={`w-4 h-4 transition-all duration-300 ${isSelected ? 'text-white' : 'text-[#00A99D] group-hover:scale-110'
                  }`} strokeWidth={2} />
