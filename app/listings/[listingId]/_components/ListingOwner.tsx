...
const ListingOwner: React.FC<ListingOwnerProps> = ({ user }) => {
  ...
  return (
    <div className="border rounded-xl p-6 bg-gray-50">
      <h3 className="text-sm text-gray-600 mb-4 uppercase">Owned by</h3>
      ...
      <div className="space-y-3 mb-6">
        ...
        <div className="flex items-start gap-3 text-sm text-gray-700">
          ...
          <div>
            <span>Damages are covered without any excess. </span>
            <button className="text-purple-600 hover:underline font-medium">Read more</button>
          </div>
        </div>
      </div>
